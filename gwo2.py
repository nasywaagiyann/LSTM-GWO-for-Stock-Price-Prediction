...
def save_model_for_streamlit(model, scaler, best_params, results, time_step=1, last_sequence=None):
    ...
    example_data = {
        'last_sequence': last_sequence.tolist() if last_sequence is not None else [],
...
def plot_5_day_forecast(df_raw, future_pred, future_dates, model_name="STANDARD GWO-LSTM"):
    ...
    # FIX: Ambil nilai skalar, bukan Series
...
def main():
    ...
    save_model_for_streamlit(model, scaler, best_params, results, time_step, last_seq)
